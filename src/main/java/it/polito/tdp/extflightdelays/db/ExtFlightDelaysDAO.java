...
public class ExtFlightDelaysDAO {
	...
	public Map<Integer,Airport> loadAllAirports() {
		...
		Map<Integer,Airport> result = new LinkedHashMap<Integer,Airport>();
	...
	public List<Rotta> getRotte(Map<Integer,Airport>aereoporti,int distanzaMedia){
		...
		try {
			...
			while (rs.next()) {
				Airport partenza = aereoporti.get(rs.getInt("id1"));
				Airport destinazione = aereoporti.get(rs.getInt("id2"));
